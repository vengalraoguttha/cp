...
public class D {
    ...
    public int longestSubstring(String s, int k) {
        ...
        for(int i = 0; i < s.length(); i++){
            boolean yes = true;
            for(int l = 0; l < 26; l++){
                if(counts[i][l] == 0) continue;
                if(counts[i][l] < k) yes = false;
            }
            if(yes){
            ...
            for(int j = i; j < s.length(); j++){
                yes = true;
                for(int l = 0; l < 26; l++){
                    if(counts[j][l] - counts[i][l] == 0) continue;
                    if(counts[j][l] - counts[i][l] < k) yes = false;
                }
                if(yes){
                    if(i != j)
    ...
    public static void main(String[] args) throws IOException {
        ...
        // code goes here
        D d = new D();
        System.out.println(d.longestSubstring(fr.next(), fr.nextInt()));
