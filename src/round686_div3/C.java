...
//                int x = lists[i].size() - 1;
                int x = 0;
                for(int ind = 1; ind < lists[i].size(); ind++){
                    if(!lists[i].get(ind).equals(lists[i].get(ind - 1) + 1)) x++;
                }
                if(lists[i].get(0) != 0) x++;
                if(lists[i].get(lists[i].size() - 1) != n - 1) x++;
