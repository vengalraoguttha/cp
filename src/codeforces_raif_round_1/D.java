package codeforces_raif_round_1;
...
public class D {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(threes + twos != ones || 2*(twos + threes) > n){
            System.out.println(-1);
            return;
        }
        sb.append(((2*twos) + (3*threes))).append("\n");
        if(((2*twos) + (3*threes)) != 0){
            int col = 1;
            int row = 1;
            for(int i = 0; i < n; i++){
                row = i + 1;
                if(arr[i] == 2){
                    ...
                    sb.append(row).append(" ").append(col + 1).append("\n");
                    col = col + 2;
                    //row++;
                } else if(arr[i] == 3){
                    sb.append(row).append(" ").append(col).append("\n");
